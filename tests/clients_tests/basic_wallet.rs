...
pub async fn run() {
    ...
    let restore_wallet_args_1 = RestoreDeterministicWalletArgs {
        ...
        autosave_current: None,
        seed: "glare cheese eclipse jeans buffalo velvet trophy lunar petal galaxy frog harmony keyboard enjoy enjoy comb foggy uneven huts gnaw warped mostly glare cheese eclipse".into(), // Fake data
        seed_offset: None,
    };
